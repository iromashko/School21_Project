...
Suite *suite_combinations(void) {
  ...
  tcase_add_loop_test(tc, test_combinations_1, 0, 1000);
  tcase_add_loop_test(tc, test_combinations_2, 0, 1000);
  tcase_add_loop_test(tc, test_combinations_3, 0, 1000);
  tcase_add_loop_test(tc, test_combinations_4, 0, 1000);
